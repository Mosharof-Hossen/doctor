...
const NavbarCreation = () => {
    return (
            <Navbar style ={{backgroundColor:"rgba(0,0,0,.3)",color : "white"}}  expand="lg">
                <Navbar.Brand className="text-white" href="#home">My Hospital</Navbar.Brand>
                ...
                <Navbar.Collapse className="text-white" id="basic-navbar-nav">
                    <Nav className="ml-auto text-white">
                        ...
                        <Link className = "mx-2" to="/dental"><Button style={{width:"100%"}} className = "header-btn text-white" variant="outline-primary">Dental Service</Button></Link>
